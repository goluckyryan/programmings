...
set yrange [0:360]
set xlabel "k [MeV/c]"
set xtics 0, 50 , 300 font ",8" 
set ylabel "angk [deg]" offset -2,0, 0
set ytics 0, 30, 360 font ",8" 
...
#========= multiplot
set multiplot layout 3, 6 title filename[9:strlen(filename)-4].comment
set tmargin 0
set bmargin 0
set lmargin 5
set rmargin 0
...
set format cb "%5.2f"
set title "DWIA 1s1/2 x 1  " ;splot filename using 1:2:($9>TdGate?$11*1:1/0) title "" pal
set title "DWIA 1p3/2 x 4  " ;splot filename using 1:2:($9>TdGate?$13*4:1/0) title "" pal
set title "DWIA 1p1/2 x 4  " ;splot filename using 1:2:($9>TdGate?$15*4:1/0) title "" pal
set title "DWIA 1d5/2 x 9  " ;splot filename using 1:2:($9>TdGate?$17*9:1/0) title "" pal
set title "DWIA 2s1/2 x 0.5" ;splot filename using 1:2:($9>TdGate?$19*0.5:1/0) title "" pal
set title "DWIA 1d3/2 x 9  " ;splot filename using 1:2:($9>TdGate?$21*9:1/0) title "" pal
