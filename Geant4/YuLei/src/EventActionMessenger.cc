...
:fEventAction(EvAct)
{
  fTestemDir = new G4UIdirectory("/tagger/");
  fTestemDir->SetGuidance("commands specific to this example");
   
  fDrawCmd = new G4UIcmdWithAString("/tagger/event/drawTracks",this);
  ...
  fPrintCmd = new G4UIcmdWithAnInteger("/tagger/event/printModulo",this);
