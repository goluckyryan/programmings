...
\centerline{
  \resizebox{15cm}{!}{ %reside the picture
    ...
    %Name the isotope
    \node at (\len/2+\len+\spa, 14){\Huge \iso{24}{O}};
    ...
    \levS{7.5}{\jpi{0}{+}}{\len+\spa}{-3*\off};
    \levS{6.0}{\jpi{1}{+}}{\len+\spa}{-2*\off};
    \levS{5.0}{\jpi{2}{+}}{\len+\spa}{-2*\off};
    \levS{8.0}{\jpi{2}{+}}{\len+\spa}{+2*\off};
    \levS{8.0}{\jpi{3}{+}}{\len+\spa}{+5*\off};
    \levS{7.6}{\jpi{4}{+}}{\len+\spa}{0};
    % Draw another level scheme SFO
    \levS{0.0}{\jpi{0}{+}}{\len+\len+2*\spa}{0};
    \levS{8.7}{\jpi{0}{+}}{\len+\len+2*\spa}{0};
    \levS{12.4}{\jpi{0}{-}}{\len+\len+2*\spa}{+\off+0.2};
    \levS{6.5}{\jpi{1}{+}}{\len+\len+2*\spa}{+4*\off};
    \levS{11.4}{\jpi{1}{-}}{\len+\len+2*\spa}{-2*\off};
    \levS{5.7}{\jpi{2}{+}}{\len+\len+2*\spa}{-4*\off};
    \levS{13.2}{\jpi{2}{-}}{\len+\len+2*\spa}{+2*\off};
    \levS{6.2}{\jpi{3}{+}}{\len+\len+2*\spa}{-2*\off};
    \levS{12.2}{\jpi{3}{-}}{\len+\len+2*\spa}{-\off};
    ...
    \levS{6.6}{\jpi{0}{+}}{3*\len+3*\spa}{-2*\off-0.3};
    \levS{6.9}{\jpi{1}{+}}{3*\len+3*\spa}{0};
    \levS{5.5}{\jpi{2}{+}}{3*\len+3*\spa}{-3*\off};
    \levS{8.0}{\jpi{2}{+}}{3*\len+3*\spa}{+3*\off};
    \levS{8.7}{\jpi{3}{+}}{3*\len+3*\spa}{+5*\off};
    \levS{7.9}{\jpi{4}{+}}{3*\len+3*\spa}{0};
