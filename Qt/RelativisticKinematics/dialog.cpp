...
void Dialog::setPlotRange(double xmin, double xmax, double ymin, double ymax)
{
    customPlot->xAxis->setRange(xmin, xmax);
    customPlot->yAxis->setRange(ymin, ymax);
}

void Dialog::setAxisLabel(QString x, QString y)
{
...
void Dialog::setScatter(int id, bool visibleline)
{
...
void Dialog::plot(int id, QString name, QVector<double> x, QVector<double> y, QPen pen)
{
