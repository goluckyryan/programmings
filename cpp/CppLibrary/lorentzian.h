...
class Lorentzian{
    public:
        ...
        Lorentzian operator * (const Lorentzian) const; //matrix multiplication
        Lorentzian operator + (const RotMatrix4D) const; //matrix multiplication
...
Lorentzian Lorentzian::operator * (const Lorentzian mat2) const{
    Lorentzian temp;
...
Lorentzian Lorentzian::operator + (const RotMatrix4D mat2) const{
...
FourVector Lorentzian::operator ^ (const FourVector v2) const{
    FourVector temp;
