...
int RKfouth (double KE, int L, int nStep, double dr, float V0, float R0, float a0){
  ...
  fprintf(paraOut, "#%12s %12s %12s %12s %12s %12s\n", "r", "Pot", "u", "du/dr", "R", "dR/dr");
  fprintf(paraOut, " %12.3E %12.3E %12.3E %12.3E %12.3E %12.3E\n", rStart, Pot(rStart, V0, R0, a0), SolU[0][0], SolU[0][1], SolU[0][0]/rStart, SolU[0][1]/rStart - SolU[0][0]/pow(rStart,2));
  ...
  for(int i = 0; i <= nStep; i++){
    ...
    fprintf(paraOut, " %12.3E %12.3E %12.3E %12.3E %12.3E %12.3E\n", r+dr, pot, SolU[i+1][0], SolU[i+1][1], SolU[i+1][0]/r, SolU[i+1][1]/r - SolU[i+1][0]/pow(r,2));
  }
